...
/*
   Template Name: systeemisch_werken-template
 */
...
<div class="references">
  ...
  <?php
  if ( defined( 'ICL_LANGUAGE_CODE' ) ) {
    $ID = (ICL_LANGUAGE_CODE == 'nl') ? 644 : 1456;
...
<div class="calendar">
  <div class="calendar-container">
    ...
    <div class="agenda agenda_in_offer">
      <?php echo do_shortcode('[tb-calendar nofilter="yes" notimezone="yes" booking="systeemisch_werken"]'); ?>
    </div>
    <div class="textWhite">
