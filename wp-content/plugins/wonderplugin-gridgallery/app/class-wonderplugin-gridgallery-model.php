...
class WonderPlugin_Gridgallery_Model {
	...
	function generate_body_code($id, $has_wrapper, $datatags = null) {
		...
		{			
			...
			// div data tag
			$ret .= '<div class="wonderplugingridgallery" id="wonderplugingridgallery-' . $id . '" data-gridgalleryid="' . $id . '" data-width="' . $data->width . '" data-height="' . $data->height . '" data-skin="' . $data->skin . '" data-style="' . $data->style . '"';
